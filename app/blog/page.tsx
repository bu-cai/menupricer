...
const POSTS = [
  ...
  {
    slug: "why-chatgpt-cant-price-your-menu",
    title: "Why ChatGPT Can't Price Your Menu (And What Actually Works)",
    description: "ChatGPT can explain the food cost formula perfectly, but it can't remember your menu, recalculate when a supplier price changes, or track which dishes it already priced.",
    category: "Menu Pricing",
    readTime: "6 min read",
    featured: false,
  },
  {
    slug: "how-to-price-a-menu-before-opening",
    title: "How to Price a Menu Before You Open (No Sales History)",
    description: "Pricing a menu before opening day means no sales data and no actual vs. theoretical food cost to check against. Here's how to price with confidence anyway.",
    category: "Menu Pricing",
    readTime: "5 min read",
    featured: false,
  },
  {
    slug: "food-truck-event-pricing",
    title: "Food Truck Pricing by Event Type",
    description: "A food truck's cost structure changes completely between a daily street spot, a private catering booking, and a festival with a vendor fee. How to price each differently.",
    category: "Food Truck",
    readTime: "5 min read",
    featured: false,
  },
  {
    slug: "meal-prep-business-pricing",
    title: "Meal Prep Business Pricing: Subscription Margin Model",
    description: "Meal prep pricing works differently from a restaurant menu — batch production changes the cost structure, and subscription cancellations change the revenue model.",
    category: "Profitability",
    readTime: "5 min read",
    featured: false,
  },
  {
    slug: "catering-quote-template",
    title: "Catering Quote Template: How to Price and Present Any Event",
    description: "A catering quote needs to cover food, labor, equipment, and travel while still being clear enough for a client to say yes quickly. What line items to include.",
    category: "Catering",
    readTime: "5 min read",
    featured: false,
  },
